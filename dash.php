...
<div class="form-group">
  <label class="col-md-12 control-label" for="desc"></label>  
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="details'.$i.'" class="form-control" placeholder="Write description here..."></textarea>  
  </div>
</div>
<br />
...
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Quiz Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=upldquiz"  method="POST">
<fieldset>
...
<div class="form-group">
    <label for="exampleInputFile" class="col-md-12 control-label">File Upload</label>
    
      <input type="file" name="file" id="file" size="150">
        <p class="help-block">Only Excel/CSV File Import.</p>
    </div>
<!--    <div class="col-md-12">
    <button type="submit" style="margin-left:45%" class="btn btn-primary" name="submit" value="submit">Upload File</button>
    </div>-->
